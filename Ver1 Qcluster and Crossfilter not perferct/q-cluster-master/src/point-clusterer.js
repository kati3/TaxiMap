...
var QCluster = (function(module){
	...
	module.PointClusterer = function(pointArr, layerId, map, clusterCssClass, opts){
		...
		this.tolerance = options.clusterTolerance || 100;
        ...
        this.defaultPalette = options.defaultPalette || ['#77C4D4', '#449AA7', '#77C168', '#C4D64C', '#F4D642', 
                                                         '#F08B33', '#E767A0', '#BF63A4', '#03671f', '#8e2b5c', 
